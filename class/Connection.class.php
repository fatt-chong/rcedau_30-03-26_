...
class Connection extends PDO {
    ...
    private string $user = "daurce";
    private string $pass = "123daurce";
    private string $server = "10.6.21.26"; // Cambia según sea necesario
    ...
    public function __construct() {
        parent::__construct(
            "{$this->dns}:host={$this->server};port={$this->port};dbname={$this->database}",
            $this->user,
            $this->pass,
            [
