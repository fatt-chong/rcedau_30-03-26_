...
$_SESSION['RCE']['pacienteCita'] 	= $datosU[0]['id_paciente'];
// print('<pre>'); print_r($existeSolicitudAltaUrgencia); print('</pre>');
...
if (
	...
	$disabled 					= 'disabled';
	$parametrosHosp['idDAU'] 	= $parametros['id_dau'];
	$rsHojaHosp 				= $objHojaHospitalizacion->obtenerDatosHojaHospitalizacion2($objCon,$parametrosHosp);
...
?>
<script type="text/javascript" src="<?=PATH?>/controllers/client/enfermera/perfil_enfermeria.js?v=<?=date('H:M:s');?>"></script>
	...
	<div class="row justify-content-center">
						...
						<div class="col-lg-12"  style="height: 100%">
							<div class="card testimonial-card" style="height: 100%"  >
		          				<div class="card-up indigo lighten-1"> 
		          					<div class="row">
		          						<div class="col-lg-9">
		          							<?php if ( array_search(1774, $permisos) != null ) { ?>
												<!-- <button id="btn_historial_link2" type="button" class="btn btn-sm btn-outline-primarydiag btn_historial_link2" data-toggle="tooltip" data-placement="top" title="Ver Historial Clínico" style="border-color: #007bff00;padding: 0rem 0.5rem;"   ><i class="fas fa-laptop-medical  mifuente18 "></i> no tocar
												</button> -->
												<?php } ?>
		          						</div>
								...
								<div class="avatar mx-auto white mt-0">
	          					...
	          					<div class="card-body pt-4">
						            <div class="row">
						            	<div class="col-md-12 ">
							            	<label style="font-weight: normal; margin-bottom: 0rem !important; font-size: 12px;" for="inputApellido"><b></b>&nbsp;&nbsp;&nbsp;&nbsp;<?php if($datosU[0]['transexual'] == 'S'){ ?>
										<i class="fas fa-venus-mars " style="color:#dd3bd1;"></i>
										<?php  } ?>
										<b><?=$infoInputLabel['input']?></b></label>
							            </div>
						            	<div class="col-md-12 ">
									...
									<div class="row">
										<div class="col-md-12">
											<button id="btnSignosVitales" name="btnSignosVitales" type="button" class="btn btn-primary btn-sm mb-2 btn-block SignoVitales"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-heartbeat throb mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Signos Vitales</label></button>
										</div>
										<div class="col-md-12">
											<button id="btnSignosVitales" name="btnSignosVitales" type="button" class="btn btn-primary btn-sm mb-2 btn-block IndicacionesEnfermeria"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-heartbeat throb mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Indicaciones Enfermeria</label></button>
										</div>
										<div class="col-md-12">
											<button id="HojaEnfermeria" name="HojaEnfermeria" type="button" class="btn btn-primary btn-sm mb-2 btn-block HojaEnfermeria"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-file-signature  mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Hoja Enfermeria</label></button>
										</div>
										<div class="col-md-12">
											<button id="formulariosEnfermeria" name="formulariosEnfermeria" type="button" class="btn btn-primary btn-sm mb-2 btn-block formulariosEnfermeria"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-file-signature  mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Formularios</label></button>
										</div>
										...
										<div class="col-md-12">
											<?php if ($obtenerEstadosIndicaciones[0]['est_id'] != 20 && $obtenerEstadosIndicaciones[0]['est_id'] === null && isset($_SESSION['datosPacienteDau']['est_id']) &&$_SESSION['datosPacienteDau']['est_id'] != 5 && $_SESSION['datosPacienteDau']['est_id'] != 6 && $_SESSION['datosPacienteDau']['est_id'] != 7) {  ?>	
												<button id="<?=$parametros['dau_id']?>" type="button" name="btnVerIndicacionAplica" class="btn btn-primary verInformacionAplicaEgreso btn-sm mb-2 btn-block SolicitudAlta">
													<svg class="svg-inline--fa fa-home fa-w-18 mr-3" style="font-size: 16px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M280.37 148.26L96 300.11V464a16 16 0 0 0 16 16l112.06-.29a16 16 0 0 0 15.92-16V368a16 16 0 0 1 16-16h64a16 16 0 0 1 16 16v95.64a16 16 0 0 0 16 16.05L464 480a16 16 0 0 0 16-16V300L295.67 148.26a12.19 12.19 0 0 0-15.3 0zM571.6 251.47L488 182.56V44.05a12 12 0 0 0-12-12h-56a12 12 0 0 0-12 12v72.61L318.47 43a48 48 0 0 0-61 0L4.34 251.47a12 12 0 0 0-1.6 16.9l25.5 31A12 12 0 0 0 45.15 301l235.22-193.74a12.19 12.19 0 0 1 15.3 0L530.9 301a12 12 0 0 0 16.9-1.6l25.5-31a12 12 0 0 0-1.7-16.93z"></path></svg><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Aplicar Egreso</label>
												</button> 
											<?php } else if ( $_SESSION['datosPacienteDau']['est_id']==5 || $_SESSION['datosPacienteDau']['est_id']==6 || $_SESSION['datosPacienteDau']['est_id']==7 ) { ?>
												<button id="" type="button" name="" class="btn btn-primary  btn-sm mb-2 btn-block " disabled>
													...
													<label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Aplicar Egreso</label>
												</button>
											<?php
											} else { ?>
										...
										<?php } ?>
										<div class="col-md-12 ">
											<button id="<?=$parametros['dau_id']?>"  name="btnNEA" type="button" class="btn btn-primary btn-sm mb-2 btn-block aplicarNEA"  data-toggle="tooltip" data-placement="left" title="N.E.A." <?php if($_SESSION['datosPacienteDau']['est_id']==5 || $_SESSION['datosPacienteDau']['est_id']==6 || $_SESSION['datosPacienteDau']['est_id']==7 || $pacienteTieneIndicacionAlta ==1){echo "disabled";}?> >
												<i class="fas fa-bullhorn text-white mr-3" style="font-size: 16px;"></i>
												<label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >N.E.A.</label>
											</button>
										</div>
										<div class="col-md-12 ">
											<button id="verIngresarLPP-<?=$parametros['dau_id']?>" type="button" name="verDetalleDau" class="btn btn-success  btn-sm mb-2 btn-block verIngresarLPP " >
													<i class="fas fa-file-medical text-white mr-3" style="font-size: 16px;"></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >LPP</label>
											</button>
										</div>
										<div class="col-md-12">
											<button id="<?=$parametros['dau_id']?>" name="verDetalleDau" type="button" class="btn btn-primary btn-sm mb-2 btn-block verDetalleDau"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-file-medical  mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Detalle DAU</label></button>
										</div>
										<?php if (pacienteTieneIndicacionAltaHospitalizacion($existeSolicitudAltaUrgencia)) { ?>
										<div class="col-md-12">
											<button  id="<?php echo $rsHojaHosp[0]['idHojaHospitalizacion'] ?>" name="verHojaHospitalizacion" type="button" class="btn btn-primary btn-sm mb-2 btn-block verHojaHospitalizacion"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-file-pdf  mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Hospitalización</label></button>
										</div>
		...
		<!-- 		<div class="col-md-12">
				...
				<?php } ?>
										...
										<div class="col-md-12">
											<button  id="btnVerRCEIncompleto" name="btnVerRCEIncompleto"type="button" class="btn btn-primary btn-sm mb-2 btn-block "  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-file-pdf  mr-3" style="font-size: 16px !important;" ></i><label style="font-size: 11px !important; margin-bottom: 0rem !important; cursor: pointer; " >Detalle RCE</label></button>
										</div>
										<BR>
										<BR>
										<hr>
										<div class="col-md-12">
											<a href="https://epivigila.minsal.cl/" target="_blank" rel="noopener"
											 class="btn btn-outline-light btn-sm col-lg-12 d-flex align-items-center justify-content-center" 
											 title="Abrir Epivigila" style="height:60px; padding:5px;">
												<img src="assets/img/epivigila.png" alt="Epivigila" style="max-height:120px; max-width:90%;">
											</a>
										</div>
									</div>
								</div>
					...
					<div class="row " style="height: 100%" >
						<div class="col-lg-12" style="height: 100%">
							<div class="card testimonial-card" style="height: 100%" >
								...
								<div class="tab-content ScrollStylePBitacora " id="myTabContent">
									<div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
								  		<div id='div_bitacora' class=" mb-1" style="background-color: white;" ></div>
								  		<div id='div_indicacion_enfermeria' class=" mb-1" style="background-color: white;" ></div>
								  		
									</div>
									<div class="tab-pane fade " id="home" role="tabpanel" aria-labelledby="home-tab">
										<div class="row">
											<div class="col-lg-4 mt-2 mb-2 text-left">
    											<a class=" mifuente12  ml-3" href="#" id="abrirPanelMedica"><i class="fas fa-chevron-left"></i> Ver Indicaciones Medicas</a> 
											</div>
											<div class="col-lg-4">											</div>
											<div class="col-lg-4 mt-2 mb-2 text-right">
    											<a class=" mifuente12  mr-3" href="#" id="abrirPanelEnfermeria">Ver Indicaciones Enfermería <i class="fas fa-chevron-right"></i></a> 
											</div>
										</div>
		...
		<div class="col-md-1" id="menu2">
			...
			<!-- <div class="row"> -->
				<!-- <div class="col-md-12">
					<button id="btnSignosVitales" name="btnSignosVitales" type="button" class="btn btn-primary btn-sm mb-2 btn-block SignoVitales"  data-toggle="tooltip" data-placement="left" title="Signos Vitales"><i class="fas fa-heartbeat throb" style="font-size: 16px !important;" ></i><br><label style="font-size: 9px !important; margin-bottom: 0rem !important; margin-top: 0.2rem !important;" >Signos Vitales</label></button>
				</div> -->
				<!-- <div class="col-md-12">
