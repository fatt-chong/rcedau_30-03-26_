...
<div w" id='divDespliegueDetalleDiagnosticosInespecificos'>
    ...
    $resultado  = $objReporte->obtenerDetalleResumenDiagnosticosInespecificos($objCon, $parametrosAEnviar, $totalPag, $total);
    ...
    ################################################################################################################################################
                                                                        CARGA JS
    -->
    <script type="text/javascript" src="<?=PATH?>/controllers/client/reportes/reportesTiemposCRUrgencia/detalleDiagnosticosInespecificos.js?v=<?=$version;?>"></script>
    ...
    <div class="titulos">
        <h3>
            <span>Detalle Diagnósticos Inespecíficos (Diagnóstico: <?php echo $campos['tipoDiagnostico']; ?>)</span>
        </h3>
    </div>
    ...
    <!-- 
    ################################################################################################################################################
                                                    DESPLIGUE PARÁMETROS DETALLE DIAGNÓSTICOS INESPECÍFICOS
    -->
    <div  class="col-lg-12">

        <form id="frm_despliegueParametrosBusquedaDiagnosticosInespecificos" name="frm_despliegueParametrosBusquedaDiagnosticosInespecificos" class="formularios" role="form" method="POST">
            ...
            <input type="hidden" id="tipoDiagnostico" name="tipoDiagnostico" value="<?= $campos['tipoDiagnostico'];?>"/>
            ...
            <div class="row">
                ...
                <div  class="form-group col-lg-2">
                    ...
                    <div class="input-group">
                        ...
                        <button id="btnBuscarDetalleDiagnosticosInespecificos" type="button" class="btn btn-default enviar btn-xs"><img src="<?=PATH?>/assets/img/dau-05_.png" alt="Buscar"></button>
                        
                        <?php
                        if( count($campos) > 1 ) { 
                        ?>

                            <button type="button" class="btn btn-default btn-xs" alt="Limpiar" title="Limpiar" id="btnEliminarFiltroBusquedaDetalleDiagnosticosInespecificos"><img src="<?=PATH?>/assets/img/dau-08.png" ></button>
    ...
    <div  class="col-lg-12">
        ...
        ?>
            ...
            <div id="resultadosDetalleDiagnosticosInespecificos">

                <table id="tablaDetalleDiagnosticosInespecificos" class="table table-hover table-condensed ">
...
function obtenerDatosEnvidasPorPOST ( $objUtil, &$campos, &$parametrosAEnviar, &$totalPag, $metodoPOST ) {
    ...
    $parametrosAEnviar['tipoDiagnostico']    = $campos['tipoDiagnostico'];
