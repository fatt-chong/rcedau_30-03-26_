...
<div  id='divDespliegueDetalleResumenTiemposEspera'>
    ...
    $resultado  = $objReporte->obtenerDetalleResumenTiemposEspera($objCon, $parametrosAEnviar, $totalPag, $total);
    ...
    ################################################################################################################################################
                                                                        CARGA JS
    -->
    <script type="text/javascript" src="<?=PATH?>/controllers/client/reportes/reportesTiemposCRUrgencia/detalleResumenTiemposEspera.js?v=<?=$version;?>"></script>
    ...
    <div class="titulos">
        <h3>
            <span>Detalle Resumen Tiempos Espera <?php echo $titulo; ?></span>
        </h3>
    </div>
    ...
    <!-- 
    ################################################################################################################################################
                                                            DESPLIGUE PARÁMETROS DETALLE TIEMPOS ESPERA
    -->
    <div  class="col-lg-12">

        <form id="frm_despliegueParametrosBusquedaDetalleResumenTiemposEspera" name="frm_despliegueParametrosBusquedaDetalleResumenTiemposEspera" class="formularios" role="form" method="POST">
            ...
            <div class="row">
                ...
                <div  class="form-group col-lg-2">
                    ...
                    <div class="input-group">
                        ...
                        <button id="btnBuscarDetalleResumenTiemposEspera" type="button" class="btn btn-default enviar btn-xs"><img src="<?=PATH?>/assets/img/dau-05_.png" alt="Buscar"></button>
                        
                        <?php
                        if( count($campos) > 1 ) { 
                        ?>

                            <button type="button" class="btn btn-default btn-xs" alt="Limpiar" title="Limpiar" id="btnEliminarFiltroBusquedaDetalleResumenTiemposEspera"><img src="<?=PATH?>/assets/img/dau-08.png" ></button>
    ...
    <div  class="col-lg-12">
        ...
        ?>
            ...
            <div id="resultadosDetalleResumenTiemposEspera">

                <table id="tablaDetalleResumenTiemposEspera" class="table table-hover table-condensed ">
