...
$html .= pdfTablaReporteEnfermedadesEpidemiologicas($parametros);
...
// $nombreArchivo = 'reporteEnfermedadesEpidemiologicas_'.date('d-m-Y').'.pdf';

// $pdf->Output($nombreArchivo,'FI');

// $url = "/dauRCE/views/reportes/enfermedadesEpidemiologicas/".$nombreArchivo;

$nombreArchivo = 'reporteEnfermedadesEpidemiologicas_'.date('d-m-Y').'.pdf';
$pdf->Output(__DIR__ . '/' . $nombreArchivo, 'FI');
$url = "/RCEDAU/views/modules/reportes/enfermedadesEpidemiologicas/".$nombreArchivo;
        ...
        <table width="100%" border="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><h2>REPORTE ENFERMEDADES EPIDEMIOLÓGICAS</h2></td>
...
function pdfTablaReporteEnfermedadesEpidemiologicas ( $parametros ) {
