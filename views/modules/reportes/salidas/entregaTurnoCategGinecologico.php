<iframe height="100%" width="100%" hidden>
	<?php		
		...
		$pdf->SetAuthor('DAU');
		$pdf->SetTitle('PDF ENTREGA TURNO CATEG GINECOLOGICO');
		...
		if ($parametros['frm_turno'] == 1) { //TURNO DIA
			...
			$datos=$reporte->entregaTurnoCategorizacionGinecologico($objCon,$parametros);
		...
		<tr>
			...
			<tr>
				<td colspan="3" class="foliochico"><strong>DAU de Pacientes sin Categorización:</strong></td>
			</tr>
			<tr>
				<td colspan="3" class="foliochico">&nbsp;</td>
			</tr>
				...
				for ($i=0; $i < count($datos) ; $i++) { 				
					...
					$html.='
							<tr align="left" valign="top">
								...
								<td width="230">'.strtoupper($datos[$i]['nombres'].' '.$datos[$i]['apellidopat'].' '.$datos[$i]['apellidomat']).' </td>
								<td width="128">  </td>
							</tr>';
				}
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	$nombre_archivo = "entregaTurnoCategGinecologico.pdf";
...
<div class="embed-responsive embed-responsive-16by9">
	<iframe id="iframeReporteCategGinecologico" class="embed-responsive-item" src="<?=$url?>" height="700" width="700" allowfullscreen></iframe>
</div>

<script>
$('#iframeReporteCategGinecologico').ready(function(){
