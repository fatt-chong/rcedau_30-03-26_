<iframe height="100%" width="100%" hidden>
	<?php		
		...
		$datos                                  = $reporte->listarPacienteGinecologica($objCon,$parametros);
		...
		<br>
			<table width="600" border="0">              
            	<tr>
    				<td colspan="3" align="center">RESUMEN  DE ATENCIONES MEDICAS POR FECHA (ADMISIÓN)<br />TIPO ATENCIÓN: GINECOLOGICA<br/>MEDICO TRATANTE: '.$parametros['medicoTratante'].'<br />TOTAL DATOS DE ATENCIÓN DE URGENCIA : '.count($datos).'</td>
  				</tr>
