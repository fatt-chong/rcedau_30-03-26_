<iframe height="100%" width="100%" hidden>
	<?php
		...
		$datos = $reporte->registroHospitalizacion($objCon,$parametros);
		...
		<table border="0">
			<tr>
				<td align="center">
					<strong style="font-size:10; color: ">REGISTRO HOSPITALIZACIÓN '.$_POST['fechaInicio'].' AL '.$_POST['fechaFin'].'</strong>
				</td>
		    </tr>
		</table>
		<br>
	...
	$nombre_archivo = "reportesRegistroHospitalizacion.pdf";

	$pdf->Output(__DIR__ . '/' . $nombre_archivo, 'FI');
	$url = "/RCEDAU/views/modules/reportes/salidas/reportesRegistroHospitalizacion.pdf";
