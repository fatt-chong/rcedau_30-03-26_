<iframe height="100%" width="100%" hidden>
	<?php		
		...
		$pdf->SetAuthor('DAU');
		$pdf->SetTitle('PDF ENTREGA TURNO CATEG Pediatrico');
		...
		if ($parametros['frm_turno'] == 1) { //TURNO DIA
			...
			$datos=$reporte->entregaTurnoCategorizacionPediatrico($objCon,$parametros);
		...
		<tr>
			...
			<tr>
				<td colspan="3" class="foliochico"><strong>DAU de Pacientes menores a 12 Años sin Categorización:</strong></td>
			</tr>
			<tr>
				<td colspan="3" class="foliochico">&nbsp;</td>
			</tr>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	$nombre_archivo = "entregaTurnoCategPediatrico.pdf";
...
<div class="embed-responsive embed-responsive-16by9">
	<iframe id="iframeReporteCategPediatrico" class="embed-responsive-item" src="<?=$url?>" height="700" width="700" allowfullscreen></iframe>
</div>

<script>
$('#iframeReporteCategPediatrico').ready(function(){
