...
$tipoPenetraciones          = array('72 Horas o Menos', 'Más de 72 Horas');
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" width="100%">
                ...
                <tr>
                    ...
                    <th colspan="32" style="text-align: center;">Sección O: Atenciones en Urgencias por Violencia Sexual (REM 2020)</th>
                ...
                <tr>
                    ...
                    <th style="vertical-align:middle;" class="mifuente11 my-1 py-1 mx-1 px-1 text-center">Hepatitis B</th>
            ...
            <tbody>
                ...
                foreach ( $tipoPenetraciones as $tipoPenetracion ) {
                    ...
                    echo '<td style="vertical-align:middle;" class="mifuente11 my-1 py-1 mx-1 px-1 text-center">'.filtrarPacientesSegunTipoPenetracionYCondicion($seccionO, 'tipoPenetracion', $tipoPenetracion, 'conHepatitisB').'</td>';
