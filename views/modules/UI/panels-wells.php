...
require(PATH."/views/modules/sesion_expirada.php");
?>
<div class="row">
    <div class="col-lg-12">
...
<div class="row">
	<div class="col-lg-6">
        <div class="card text-white bg-primary">
          <div class="card-header py-0">Header</div>
          <div class="card-body">
            <h5 class="card-title">Primary card title</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          </div>
          <div class="card-footer py-0">2 days ago</div>
        </div>
        <div class="card text-white bg-secondary">
          <div class="card-header py-1">Header</div>
          <div class="card-body">
            <h5 class="card-title">Secondary card title</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          </div>
          <div class="card-footer py-1">2 days ago</div>
        </div>
	...
	<div class="col-lg-6">
		<div class="card border-primary">
          ...
          <div class="card-footer text-muted py-0">2 days ago</div>
        </div>
        <div class="card border-secondary">
          ...
          <div class="card-footer text-muted py-1">2 days ago</div>
        </div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="card">
			<div class="card-header">Accordion example</div>
            <div class="card-body">
				<div class="row">
                    <div class="col-lg-12">
  ...
  <div class="card">
    ...
    <div class="col-lg-6">
    	<div class="card">
			<div class="card-header">Multiple targets</div>
            <div class="card-body">
				<div class="row">
                    <div class="col-lg-12">
                    <p>
...
<div class="row">
	<div class="col-lg-6">
    	<div class="card">
			<div class="card-header">Quick Form</div>
            <div class="card-body">
				<div class="row">
                    <div class="col-lg-12">
...
<div class="row">
	<div class="col-lg-3">
    	<div class="card">
          <img class="card-img-top" src="<?=RAIZ?>/assets/img/logo_hospital.png" alt="Card image cap">
          <div class="card-body">
